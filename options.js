document.addEventListener("DOMContentLoaded", () => {
  ...
  const notionSecret = document.getElementById("notionSecret");
  ...
  limitRemoved.onchange = () => {
    if (limitRemoved.checked) {
      ...
      status.innerHTML =
        "WARNING: Recordings that are too long may not save properly!";
    } else {
  ...
  notionSecret.onchange = () => {
    status.innerHTML = "";
  };

  notionPageId.onchange = () => {
    status.innerHTML = "";
  };
